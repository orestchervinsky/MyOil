-- Extends resolve_overdue_workers() (0004) to also resolve transport_events
-- and credit the field's stockpile from completed extractions, matching the
-- extract -> transport -> refine chain added in 0005.
